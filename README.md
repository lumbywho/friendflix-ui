...
- [Operating system / development environment 🖥️](#operating-system)
- [Programming languages 📝](#programming-languages)
- [Library dependencies 📚](#library-dependencies)
- [Project folder hierarchy 📂](#project-folder-hierarchy)
- [Installation steps 📋](#installation-steps) 
- [List of tools used 🛠️](#list-of-tools) 
- [Parts generated by tools 🏭](#generated-by-tools) 
- [Code written by me ✍🏼](#coded-by-me)
- [User Goals - in action! (GIFs) 🏃](#user-goals)
- [Design Guidelines Applied ✔️](#design-guidelines) 
